...
egg_carton1_average = np.average(egg_carton1)
print(egg_carton1_average * 100)
egg_carton2_average = np.average(egg_carton2)
print(egg_carton2_average * 100)
egg_carton3_average = np.average(egg_carton3)
print(egg_carton3_average * 100)
